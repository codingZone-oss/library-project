from PySide6.QtWidgets import  QWidget, QHBoxLayout, QMainWindow, QVBoxLayout, QSizePolicy, QLabel, QGraphicsDropShadowEffect
from PySide6.QtCore import Qt
from PySide6.QtGui import QColor


class Manager1(QMainWindow):
    ...
    # creating a maneger page
        ...
        self.lyt_manager = QVBoxLayout(self.wgt_manager)
        self.wgt_manager.setObjectName("readers")
        self.wgt_manager.setStyleSheet(" #readers {background-color: rgb(7, 30, 71); border-radius: 10px; height: 50px; }")

    # adding self.top_wgt on lyt_manager
    ...
    # adding sub_top_wgt on lyt_manager
    ...
    # adding the 4 main_widget on lyt_manager

        self.lyt_manager.addWidget(self.top_wgt)
        self.lyt_manager.addWidget(self.sub_top_wgt)
        self.lyt_manager.addWidget(self.body_wgt)
        self.lyt_manager.addWidget(self.bottom_wgt)
